...
class VM(models.Model):
    """ """
    vm_name = models.CharField(max_length=100, blank=True, default='', verbose_name="Virtual Machines")
    ip = models.CharField(max_length=100, blank=True, default='', verbose_name="IP")
    ...
    tag = models.CharField(max_length=100, blank=True, default='dec', verbose_name="Tag")
    ...
    def all_vms():
        """"""
        return [x.vm_name for x in VM.objects.all()]
